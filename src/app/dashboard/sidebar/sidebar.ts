...
import { Router, NavigationEnd, ActivatedRoute, RouterModule, IsActiveMatchOptions } from '@angular/router';
...
export class Sidebar implements OnInit, OnDestroy {
  ...
  isLinkActive(routerLink: string | undefined, options: IsActiveMatchOptions | undefined): boolean {
    ...
    return this.router.isActive(routerLink, options || { paths: 'exact', queryParams: 'ignored', matrixParams: 'ignored', fragment: 'ignored' });
  }
